...
date: "2023-06-28"
description: 搜索 搜索就是对状态空间进行枚举来查找所有种可能来找到问题的最优解或可行解的个数。搜索一般时间或空间复杂度很高，所以有很多优化方法,如记忆化、减枝等。 注意 不同的搜索题目大都不相同，DFS/BFS两种算法更像是方法，要理解它的思想并灵活运用，死套模板是没有用的。要根据不同的问题来选择更好的方法来解决。 一.DFS 深度优先搜索 定义 一种用于遍历或搜索树或图的算法（俗称 不撞南墙不回头算法 ） ...
# project: project1
tags: ['学习笔记', '搜索']
draft: false
---
